(function ($) {
  ...
  /*============= preloader js css =============*/
  var cites = [];
  cites[0] = 'You can create long article with AiFuse';
  cites[1] = 'You can create Blogs with AiFuse.';
  cites[2] = 'You can create social ad with AiFuse';
  cites[3] = 'You can generate images with AiFuse';
