                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">
                            <div class="logo"><img
                                                src="{{ url('storage/app/public/icon/aiimages.svg') }}"
                                                style="width:30px;max-height:30px;"></div>&nbsp; &nbsp;
                              
                            <h4 style="line-height:24px;">Edit Images</h4>
                        </div>
                       
                        <p class="text-gray text-sm">Automatically Edit Images With AI.</p>
                         <form class="row g-3 needs-validation" id="newform"  enctype="multipart/form-data" method="post">
                             @csrf
                            <div class="fields">
								
								 <div class="field_row mt-2">
                                  <div class="field full w-100">
                                            <label for="validationCustom01" class="form-label">Select Image<span style="color:red">*</span></label>
                              ...
                              <div class="field full mt-3 w-100">
                                    <div class="flex items-center content-center justify-between">
                                        <label for="title">What you want to edit in image?<span style="color:red">*</span></label>
                                        
                                    </div>
                                    <textarea name="title" id="title"
                                        placeholder="Pro Tip💡 try adding a simple instuction or style description. Example: make the sky red, add flowers to the background, turn the cat into a rabbit." rows="5"
                                        required="required" id="title"></textarea>
                                </div>
                    ...
                    <div class="card-body ideacontent" >
                        ...
                        <div class="height-align text-center new"  id="hideit">
                         ...
                         <div class="height-align text-center new">
                           ...
                           <div class="card  mb-3" id="showimage" >
    ...
    <script type="text/javascript">
        ...
        $(".btn-submit").click(function(e) {
            ...
            $.ajax({
                ...
                type: "POST",
                url: '<?php echo e(route('get_edited_image')); ?>',
                data: formData,
                processData: false,
                contentType: false,
