...
@section('content')
<?php
$use_cases =\App\Models\HowTo::where('name','usecases')->select('id','main_content','main_heading','name')->first();
// dd($use_cases);
...
.cardcheckbox {
    ...
    <div class="container card">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div class="col-6 ">
            <h4 class=""><span style="border-bottom: 4px solid #6773ff;">Use Cases section</span></h4>
          </div>
          <div class="col-6">
 ...
 <div class="modal fade" id="boxes" tabindex="-1" aria-labelledby="folderLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{route('admin.use_cases_create')}}" method="post" enctype="multipart/form-data">
            @csrf
  ...
  <div class="modal fade" id="editsection" tabindex="-1" aria-labelledby="folderLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{route('admin.how_to_section_update',$use_cases->id)}}" method="post" enctype="multipart/form-data">
            @csrf
          <div class="modal-body">
            <div class="form-group">
              <div class="row mb-3">
                  <div class="col-6">
                      ...
                      <div class="col-sm-12">
                          <input type="text" name="main_heading" class="form-control" id="main_heading" autocomplete="off" value="{{$use_cases->main_heading}} ">
                      </div>
                  </div>
                  <div class="col-6">
                      <label for="main_content">Main Content</label>
                      <div class="col-sm-12">
                          <input type="text" name="main_content" class="form-control" id="main_content" autocomplete="off" value="{{$use_cases->main_content}} ">
                      </div>
                  </div>
              </div>
    ...
    $(document).ready(function() {
        $(function () {
            var table = $('.data-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.use_cases_list') }}",
                columns: [
                    {
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                    ...
                    },
                    {
                        ...
                        name: 'icon',render: function (data, type, row, meta) {
                          ...
                          return '<img src="{{$url_aws}}use_cases_box/'+data+'" alt="img" height="50px">';
                        }
                    },
                    {
                        data: 'action',
