      ...
      <div class="column is-6 is-offset-3">
        ...
        <div class="box">
          ...
          @if(!extension_loaded('curl'))
            <div class='notification is-danger is-light' style='padding:12px;'><i class='fa fa-times'></i> Curl extension missing!</div>
          @else
            <div class='notification is-success is-light' style='padding:12px;'><i class='fa fa-check'></i> Curl extension available</div>
          @endif

          @if(phpversion() >= "8.1.0" && extension_loaded('mysqli') && extension_loaded('curl'))
