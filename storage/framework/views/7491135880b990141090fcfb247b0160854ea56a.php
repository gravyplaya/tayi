...
<nav class="sidebar">
      <div class="sidebar-header">
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-brand">
          <img src="<?php echo e($url_aws); ?>admin/<?php echo e($footer_logo); ?>" alt="" style="width:100px; max-height:100px">
        </a>
      ...
      <div class="sidebar-body">
       ...
       <li class="nav-item nav-category">Reports</li>
           <li class="nav-item">
            <a href="<?php echo e(route('admin.populartools')); ?>" class="nav-link">
              <i class="link-icon" data-feather="calendar"></i>
              <span class="link-title">Most Used Tools</span>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('admin.liked_disliked_report')); ?>" class="nav-link">
           ...
           <li class="nav-item">
            <a href="<?php echo e(route('admin.membership.list')); ?>" class="nav-link">
              <i class="link-icon" data-feather="percent"></i>
              <span class="link-title">Memberships</span>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('admin.plan.list')); ?>" class="nav-link">
              <i class="link-icon" data-feather="percent"></i>
           ...
           <li class="nav-item">
            ...
            <div class="collapse" id="category">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="<?php echo e(route('admin.category.list')); ?>" class="nav-link">Category List</a>
                </li>
                 <li class="nav-item">
                  <a href="<?php echo e(route('admin.category.add')); ?>" class="nav-link">Add Category</a>
                </li>
              </ul>
            </div>
          </li>
           ...
           <li class="nav-item">
            ...
            <div class="collapse" id="emails">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="<?php echo e(route('admin.template.list')); ?>" class="nav-link">Prompt List</a>
                </li>
                 <li class="nav-item">
                  <a href="<?php echo e(route('admin.template.add')); ?>" class="nav-link">Add Prompt</a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="users">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="<?php echo e(route('admin.language.list')); ?>" class="nav-link">language List</a>
                </li>
                <li class="nav-item">
                  <a href="<?php echo e(route('admin.language.add')); ?>" class="nav-link">Add New Language</a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="awards">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="<?php echo e(route('admin.award')); ?>" class="nav-link">Badges list</a>
                </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="useras">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="<?php echo e(route('admin.user.list')); ?>" class="nav-link">User List</a>
                </li>
                <li class="nav-item">
                  <a href="<?php echo e(route('admin.user.add')); ?>" class="nav-link">Add New User</a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('admin.user.docs')); ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('admin.user.history')); ?>" class="nav-link">
           ...
           <li class="nav-item">
            <a href="<?php echo e(route('admin.user.transactions')); ?>" class="nav-link">
              <i class="link-icon" data-feather="file"></i>
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#notifications" role="button" aria-expanded="false" aria-controls="notifications">
              <i class="link-icon" data-feather="users"></i>
              <span class="link-title"><?php echo e(__('lang.notification')); ?></span>
              <i class="link-arrow" data-feather="chevron-down"></i>
            </a>           
            <div class="collapse" id="notifications">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="<?php echo e(route('admin.notification')); ?>" class="nav-link"><?php echo e(__('lang.notification')); ?></a>  
                </li>
                <li class="nav-item">
                  <a href="<?php echo e(route('admin.notification.email')); ?>" class="nav-link"><?php echo e(__('lang.sendmail')); ?></a>
                </li>
              </ul>
            </div>
</li>
          ...
          <li class="nav-item">
			...
			<li class="nav-item">
            <a href="<?php echo e(route('admin.edithomepage')); ?>" class="nav-link">
              <i class="link-icon" data-feather="box"></i>
              <span class="link-title">Website Settings</span>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('admin.payment_gateway.index')); ?>" class="nav-link">
              <i class="link-icon" data-feather="box"></i>
...
<?php /**PATH C:\xampp\htdocs\tayiwithoutinstaller\resources\views/admin/layout/sidebar.blade.php ENDPATH**/ ?>