...
<footer class="footer d-flex flex-column flex-md-row align-items-center justify-content-between px-4 py-3 border-top small">
        <p class="text-muted mb-1 mb-md-0"><?php echo e($footer_text1); ?> <a href="<?php echo e(url('/')); ?>" target="_blank"><?php echo e($appname); ?></a>.</p>
        <p class="text-muted"><?php echo e($footer_text2); ?></p>
      </footer><?php /**PATH C:\xampp\htdocs\tayiwithoutinstaller\resources\views/admin/layout/footer.blade.php ENDPATH**/ ?>